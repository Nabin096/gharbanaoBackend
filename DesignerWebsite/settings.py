...
SECRET_KEY = '&f8o=$k8jxo-f8ezy*k0p6sfc&0nv6q!w57deo&ddyh_!#m0q_'
...
INSTALLED_APPS = [
    'designers.apps.DesignersConfig',
...
ROOT_URLCONF = 'DesignerWebsite.urls'
...
WSGI_APPLICATION = 'DesignerWebsite.wsgi.application'
...
REST_FRAMEWORK={
    'DEFAUALT_AUTHENTICATION_CLASSES':(
